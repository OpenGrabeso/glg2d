...
public interface GLUtessellatorCallback {
   ...
   * {@code glBegin} to indicate the start of a
   ...
   *
   * @see GLUtessellator#gluTessCallback           gluTessCallback
   * @see #end     end
   * @see #begin   begin
   */
   ...
   * GLUtessellator#gluTessBeginPolygon gluTessBeginPolygon} was called.
   *
   * @param type
   *        Specifics the type of begin/end pair being defined.  The following
   *        values are valid:  <b>GL_TRIANGLE_FAN</b>, <b>GL_TRIANGLE_STRIP</b>,
   ...
   * {@code glEdgeFlag}. The method takes
   ...
   * {@link GLUtessellator#gluTessBeginPolygon gluTessBeginPolygon} was called.
   *
   * @param boundaryEdge
   *        Specifics which edges lie on the polygon boundary.
   * @param polygonData
   ...
   * GLUtessellator#gluTessVertex gluTessVertex}).
   *
   * @param vertexData
   ...
   * {@code glEnd}. It indicates the end of a
   ...
   * {@link GLUtessellator#gluTessEndPolygon gluTessEndPolygon} is
   * called.<P>
   *
   ...
   * {@link GLU#errorString gluErrorString} call.<P>
   *
